...
DEB_DISTROS=${DEB_DISTROS:-Ubuntu:bionic Ubuntu:focal Ubuntu:jammy Ubuntu:noble Ubuntu:noble:arm64 Ubuntu:resolute Ubuntu:resolute:arm64 Ubuntu:stonking Debian:bullseye Debian:bookworm Debian:trixie Debian:trixie:arm64 Debian:trixie:riscv64 Debian:forky Debian:forky:arm64 Debian:forky:riscv64 Debian:sid Debian:sid:arm64 Debian:sid:riscv64}
